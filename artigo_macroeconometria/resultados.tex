...
\citeonline{mcleod_diagnostic_1983}. O teste \(Q\) possui hipótese nula de ausência de
autocorrelação:
...
(\(Q_R(m)\)). Para mais detalhes sobre estes testes \citeonline{tsay_multivariate_2013} fornece
