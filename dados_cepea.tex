...
\section{Dados e Análise Descritiva.}\label{dados-e-analise-descritiva.}
...
\subsection{Estimação dos modelos GARCH BEKK e
DCC.}\label{estimacao-dos-modelos-garch-bekk-e-dcc.}
